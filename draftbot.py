...
DECK_ARCHYTYPES = ("WU", "WB", "WR", "WG", "UB", "UR", "UG", "BR", "BG", "RG")
...
class Draft:
    ...
    def __init__(self, 
                 n_drafters=8,
                 n_rounds = 3,
                 deck_archytypes=DECK_ARCHYTYPES,
...
class Drafter:
    ...
    def __init__(self, archytype_preferences=None):
        if not archytype_preferences:
            archytype_preferences = {arch: 1 for arch in DECK_ARCHYTYPES}
